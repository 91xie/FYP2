<?php   
 ...
 include("/var/www/pChart2.1.4/class/pData.class.php");
 include("/var/www/pChart2.1.4/class/pDraw.class.php");
 include("/var/www/pChart2.1.4/class/pImage.class.php");
 include("/var/www/pChart2.1.4/class/pScatter.class.php");
 ...
 /* Draw the legend */
 $myScatter->drawScatterLegend(280,380,array("Mode"=>LEGEND_HORIZONTAL,"Style"=>LEG$
