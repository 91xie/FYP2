...
$result = mysqli_query($con, "SELECT * FROM t limit 1,10");//1.
...
{ 
 $myData->addPoints($row['item'],"Probe 1");
 $myData->addPoints($row['item'],"Probe 2"); 
 $myData->addPoints($row['mean'],"Probe 3");
}
...
// for ($i=0;$i<=10;$i=$i+1) { $myData->addPoints(rand(1,20),"Probe 3"); }
 ...
 $myScatter->drawFilledSplineChart();
