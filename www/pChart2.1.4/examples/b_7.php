...
$result = mysqli_query($con, " SELECT * FROM (SELECT * FROM w ORDER BY item DESC LIMIT 10)sub ORDER BY item ASC");//1.
...
// $myPicture->drawRectangle(0,0,699,298,array("R"=>0,"G"=>0,"B"=>0));
 ...
 $myPicture->drawText(150,35,"w [m/s]",array("FontSize"=>20,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE));
